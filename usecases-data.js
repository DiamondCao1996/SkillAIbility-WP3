...
const BASELINE_CODES = {
  TA:[
    ...
    {id:"TA10", label:"Manageable cognitive and attentional demands – task demands related to information processing, attention, memory and mental workload should remain manageable, avoiding cognitive overload and supporting safe and effective performance (Parker & Grote, 2022; Grosse et al., 2023)"},
    {id:"TA11", label:"Meaningful human contribution and decision autonomy – tasks should preserve meaningful human judgement, expertise and discretion over relevant decisions, particularly when AI or automation provides recommendations or performs part of the task (Fani et al., 2026)"},
    {id:"TA12", label:"Task variability and exception handling – tasks should allow workers to recognise, interpret and manage non-routine situations and unexpected events, with technological support where appropriate; adaptive automation addresses dynamic function allocation in response to emerging or unpredictable contingencies (Endsley, 2023; Bernabei & Costantino, 2024)"},
  ],
  TE:[
    {id:"TE1", label:"Physical functions – adjust spacing in projected assembly instructions (Jakšić et al., 2026)"},
    {id:"TE2", label:"Cognitive support – in-situ instructions, continuous assistance (Jakšić et al., 2026)"},
    {id:"TE3", label:"Cognitive support – two-way communication (Jakšić et al., 2026)"},
    {id:"TE4", label:"Cognitive support – feedback systems (Jakšić et al., 2026)"},
    {id:"TE5", label:"Cognitive support – automatic detection of instances where the operator does not know how to initiate interaction (Jakšić et al., 2026)"},
    {id:"TE6", label:"Sensing functions – appropriate mode of instruction (visual, audio, lights, verbal, different colour schemes) (Jakšić et al., 2026)"},
    {id:"TE7", label:"Simulation for work planning (Jakšić et al., 2026)"},
    {id:"TE8", label:"Dynamic adjustment to skill level (Jakšić et al., 2026)"},
    {id:"TE9", label:"Suitable information density, e.g. number of simultaneously shown instructions (Jakšić et al., 2026)"},
    ...
    {id:"TE17", label:"Confidence and uncertainty indication – AI-based recommendations explicitly communicate their confidence, uncertainty or limits of applicability, so workers can calibrate their reliance on the system (Endsley, 2023; Li et al., 2025)"},
    {id:"TE18", label:"Adjustable automation with human takeover – the level of automation and human–machine task allocation is adjustable to the operational context, and the worker can pause, override or reassume control when needed (Bernabei & Costantino, 2024; Fani et al., 2026)"},
    {id:"TE19", label:"Multimodal fault notification and guided recovery – faults are communicated through accessible visual, auditory and/or haptic signals, with clear step-by-step recovery instructions or safe fallback procedures (Endsley, 2023; Li et al., 2025; Jakšić et al., 2026)"},
    {id:"TE20", label:"Multiple modes of instruction to accommodate a variety of capabilities, e.g. both visual and audio (Jakšić et al., 2026)"},
    {id:"TE21", label:"Customisable colour schemes for people with limited visual acuity (Jakšić et al., 2026)"},
    {id:"TE22", label:"Dynamic task allocation based on operator capabilities (Jakšić et al., 2026)"},
    {id:"TE23", label:"Gamified elements to increase motivation (Jakšić et al., 2026)"},
  ],
  OR:[
    {id:"OR1", label:"Flexible study methods – online learning (Jakšić et al., 2026)"},
    {id:"OR2", label:"Continuous training (Jakšić et al., 2026)"},
    {id:"OR3", label:"Job rotation in different stations (Jakšić et al., 2026)"},
    {id:"OR4", label:"Job enlargement (Jakšić et al., 2026)"},
    {id:"OR5", label:"Value workers' long experience (Jakšić et al., 2026)"},
    {id:"OR6", label:"Knowledge-oriented leadership (Jakšić et al., 2026)"},
    {id:"OR7", label:"Training through direct interaction with technology (Jakšić et al., 2026)"},
    {id:"OR8", label:"Training through direct contact with experts, e.g. visits and practical lectures (Jakšić et al., 2026)"},
    ...
    {id:"OR11", label:"Supportive organisational culture – the organisation fosters a culture supportive of human-centric technological change, promoting openness, trust and learning, and reducing resistance to change (Bucci et al., 2025; Altepost et al., 2024)"},
    {id:"OR12", label:"Cross-functional coordination and competence integration – the organisation enables coordination across functions and integrates complementary worker competences and knowledge to support effective technology adoption and human–technology integration (Bucci et al., 2026)"},
    {id:"OR13", label:"Ongoing worker participation and feedback – workers remain involved throughout technology implementation and use, with formal mechanisms to give feedback and contribute to the iterative improvement of technologies and work systems (Fani et al., 2024; Haipeter et al., 2024)"},
  ],
};
